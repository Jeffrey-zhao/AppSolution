        ...
        function _31a(menu) {
            menu.addClass("menu").find(">div").each(function () {
                ...
                if (item.hasClass("menu-sep")) {
                    ...
                    var _31c = $.extend({}, $.parser.parseOptions(this, ["name", "iconCls", "href"]), {
    ...
    $.fn.menu = function (_33a, _33b) {
        ...
        return this.each(function () {
            ...
            if (_33c) {
                ...
                _33c = $.data(this, "menu", {
                    options: $.extend({}, $.fn.menu.defaults, $.fn.menu.parseOptions(this), _33a)
                });
                init(this);
            }
            $(this).css({
        ...
        return this.each(function () {
            ...
            if (_34d) {
                ...
                $.data(this, "menubutton", {
                    options: $.extend({}, $.fn.menubutton.defaults, $.fn.menubutton.parseOptions(this), _34b)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
        ...
        return this.each(function () {
            ...
            if (_358) {
                ...
                $.data(this, "splitbutton", {
                    options: $.extend({}, $.fn.splitbutton.defaults, $.fn.splitbutton.parseOptions(this), _356)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_389) {
                ...
                $.data(this, "validatebox", {
                    options: $.extend({}, $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this), _387)
                });
            }
            _378(this);
        });
    ...
    $.fn.validatebox.parseOptions = function (_38a) {
        var t = $(_38a);
        return $.extend({}, $.parser.parseOptions(_38a, ["validType", "missingMessage", "invalidMessage"]), {
        ...
        return this.each(function () {
            ...
            if (_3e7) {
                ...
                _3e7 = $.data(this, "calendar", {
                    options: $.extend({}, $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _3e5)
                });
                init(this);
            }
        ...
        return this.each(function () {
            ...
            if (_405) {
                ...
                $.data(this, "numberspinner", {
                    options: $.extend({}, $.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this), _402)
                });
            }
            _3fe(this);
        });
        ...
        return this.each(function () {
            ...
            if (_41f) {
                ...
                $.data(this, "timespinner", {
                    options: $.extend({}, $.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this), _41c)
                });
                _408(this);
            }
        });
        ...
        return this.each(function () {
            ...
            if (_5f9) {
                ...
                $.data(this, "propertygrid", {
                    options: $.extend({}, $.fn.propertygrid.defaults, $.fn.propertygrid.parseOptions(this), _5f6)
                });
            }
            _5f0(this);
        });
...
(function ($) {
    ...
    $.fn.treegrid.parseOptions = function (_699) {
        return $.extend({}, $.fn.datagrid.parseOptions(_699), $.parser.parseOptions(_699, ["treeField", {
            animate: "boolean"
        }]));
    };
        ...
        return this.each(function () {
            ...
            if (_74c) {
                ...
                _74c = $.data(this, "combobox", {
                    options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _749)
                });
                _747(this);
                _73b(this, _739(this));
            }
    ...
    $.fn.combotree = function (_766, _767) {
        ...
        return this.each(function () {
            ...
            if (_769) {
                ...
                $.data(this, "combotree", {
                    options: $.extend({}, $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _766)
                });
            }
            _75a(this);
        });
        ...
        return this.each(function () {
            ...
            if (_787) {
                ...
                _787 = $.data(this, "combogrid", {
                    options: $.extend({}, $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _784)
                });
            }
            _76d(this);
        });
    ...
    $.fn.datebox = function (_79b, _79c) {
        ...
        return this.each(function () {
            ...
            if (_79e) {
                ...
                $.data(this, "datebox", {
                    options: $.extend({}, $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _79b)
                });
            }
            _78b(this);
        });
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_7b7) {
                ...
                $.data(this, "datetimebox", {
                    options: $.extend({}, $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _7b4)
                });
            }
            _7a1(this);
        });
    ...
    $.fn.datetimebox.parseOptions = function (_7b9) {
        var t = $(_7b9);
        return $.extend({}, $.fn.datebox.parseOptions(_7b9), $.parser.parseOptions(_7b9, ["timeSeparator", {
            showSeconds: "boolean"
        }]));
    };
